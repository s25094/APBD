...
namespace RevenueRecognitionSystem.Migrations
{
    ...
    [Migration("20240616174741_InitialMigration2")]
            ...
            modelBuilder.Entity("RevenueRecognitionSystem.Model.Discount", b =>
                {
                    ...
                    b.Property<int?>("UpfrontContractContractId")
                        .HasColumnType("int");

                    b.HasKey("DiscountId");

                    b.HasIndex("UpfrontContractContractId");
            ...
            modelBuilder.Entity("RevenueRecognitionSystem.Model.Discount", b =>
                {
                    b.HasOne("RevenueRecognitionSystem.Model.UpfrontContract", null)
                        .WithMany("Discounts")
                        .HasForeignKey("UpfrontContractContractId");
                });
